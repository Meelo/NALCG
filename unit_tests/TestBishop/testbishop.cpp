...
void TestBishop::blackValidMoves_data()
{
    ...
    PieceHolder createUnitsAt10[] = {   PieceHolder(38, new Bishop(BLACK)),
                                        PieceHolder(18, new Bishop(WHITE)),
                                        PieceHolder(11, 0) };
    PieceHolder createUnitsAt11[] = {   PieceHolder(36, new Bishop(BLACK)),
                                        PieceHolder(18, new Bishop(WHITE)),
                                        PieceHolder(11, 0) };
    ...
    std::size_t case10[] = { 11 };
    std::size_t case11[] = { 18 };
    ...
    QTest::newRow("king is under attack by bishop at c6, bishop at g4 [bug]")
        << std::size_t(38) << std::vector<PieceHolder>
        (createUnitsAt10, createUnitsAt10 + sizeof(createUnitsAt10) / sizeph)
        << std::vector<std::size_t>(case10, case10 + sizeof(case10) / sizet);

    QTest::newRow("king is under attack by bishop at c6, bishop at e4 [bug]")
        << std::size_t(36) << std::vector<PieceHolder>
