...
void TestQueen::whiteValidMoves_data()
{
    ...
    PieceHolder createUnitsAt04[] = {   PieceHolder(51, new Queen(Piece::WHITE)),
                                        PieceHolder(33, new Pawn(Piece::WHITE)),
                                        PieceHolder(37, new Pawn(Piece::WHITE)),
                                        PieceHolder(27, new Pawn(Piece::WHITE)) };
    PieceHolder createUnitsAt05[] = { PieceHolder(50, new Pawn(Piece::BLACK)) };
    ...
    PieceHolder createUnitsAt08[] = {   PieceHolder(10, new Queen(Piece::WHITE)),
                                        PieceHolder(18, new Pawn(Piece::BLACK)) };
    PieceHolder createUnitsAt09[] = { PieceHolder(10, new Queen(Piece::WHITE)) };
    PieceHolder createUnitsAt10[] = { PieceHolder(36, new Queen(Piece::WHITE)) };
...
void TestQueen::blackValidMoves_data()
{
    ...
    PieceHolder createUnitsAt06[] = {   PieceHolder(11, new Queen(Piece::BLACK)),
                                        PieceHolder(25, new Pawn(Piece::BLACK)),
                                        PieceHolder(35, new Pawn(Piece::BLACK)),
                                        PieceHolder(29, new Pawn(Piece::BLACK)) };
    PieceHolder createUnitsAt07[] = { PieceHolder(10, new Pawn(Piece::WHITE)) };
    PieceHolder createUnitsAt08[] = { PieceHolder(11, new Pawn(Piece::WHITE)) };
    PieceHolder createUnitsAt09[] = { PieceHolder(12, new Pawn(Piece::WHITE)) };
    PieceHolder createUnitsAt10[] = {   PieceHolder(52, new Queen(Piece::BLACK)),
                                        PieceHolder(44, new Pawn(Piece::WHITE)),
                                        PieceHolder(34, new Pawn(Piece::WHITE)),
                                        PieceHolder(38, new Pawn(Piece::WHITE)) };
    PieceHolder createUnitsAt11[] = { PieceHolder(53, new Queen(Piece::BLACK)) };
    PieceHolder createUnitsAt12[] = { PieceHolder(38, new Queen(Piece::BLACK)) };
